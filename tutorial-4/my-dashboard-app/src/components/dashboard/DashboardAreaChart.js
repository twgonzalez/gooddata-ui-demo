...
import { DataViewFacade, useCancelablePromise } from '@gooddata/sdk-ui';
...
const DashboardAreaChart = ({
    ...
    useCancelablePromise(
        ...
        [measure, viewBy, stackBy, dateFilter, attributeFilter],
    );

    return (
        <>
            {loadingData && <div style={{ lineHeight: '300px' }}>Loading Data ...</div>}
            {!loadingData && (
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        {series.map((d, i) => {
                            return (
                                <Area
                                    cursor={isDrillable === true ? 'pointer' : 'default'}
                                    type="monotone"
                                    dataKey={d}
                                    stackId="1"
