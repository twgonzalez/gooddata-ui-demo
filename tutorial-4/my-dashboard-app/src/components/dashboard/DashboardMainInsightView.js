            ...
            <div className={styles.Filters}>
                <div className={styles.ButtonGroup}>
                    <ButtonGroup color="primary" aria-label="outlined primary button group">
                        <Button
                            variant={timeGrain === 0 ? 'contained' : 'outlined'}
                            onClick={() => handleTimeGrainChange(0)}
                        >
                            This Year
                        </Button>
                        <Button
                            variant={timeGrain === 1 ? 'contained' : 'outlined'}
                            onClick={() => handleTimeGrainChange(1)}
                        >
                            This Quarter
                        </Button>
                        <Button
                            variant={timeGrain === 2 ? 'contained' : 'outlined'}
                            onClick={() => handleTimeGrainChange(2)}
                        >
                            This Month
                        </Button>
                    </ButtonGroup>
