...
const Welcome = () => (
    <Page>
        ...
        <p>
            Now, let’s take one more step and set up your home dashboard with a test headline report widget.
            This will help verify that everything is set up correctly.
        </p>
        ...
        <ol>
            ...
            <li>
                <p>
                    In the root of the boilerplate, run <Code>yarn refresh-ldm</Code>, the terminal then will
                    prompt you to enter <Code>Username/Password</Code> and <Code>workspace</Code>
                    selection.
                    <br />
                    After that, the script will create a file <Code>/src/ldm/full.ts</Code> which will contain
                    all <Code>LDM</Code> objects, metrics and insights that are in the selected
                    <Code>workspace</Code>.
                    <br />
            ...
            <li>
                ...
                <p>
                    ...
                    objects.
                    <br />
                    The main benefit of utilizing the generated LDM objects is that you have the access to all
                    LDM objects, metrics and insights in the workspace that you selected.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                ...
                <p>
                    Most likely, the value of your headline report would be different. As long as you do not
                    see an error, you are good to go. If you do see an error, please use one of the{' '}
        ...
        <ul>
            <li>
                The <Code>Workspace</Code> context object in <Code>/src/contexts/Workspace.js</Code> stores
                the actual workspace ID and provides it to the rest of the app. It also stores it in URL query
                string so that the app can be easily embedded or linked with a particular workspace
                pre-selected. If no workspace ID is found in the URL, <Code>workspace</Code> from{' '}
        ...
        <p>
            Explore the <a href="https://gooddata-examples.herokuapp.com">Live Examples</a> and try out some
            code snippets.
        </p>
...
git commit -m "Setup Heroku deployment"`}</Pre>
            ...
            <li>
                ...
                <br />
                <b>NOTE:</b> If cross-domain requests are not allowed, you will not be able to log in and will
                see a cross-domain error message.
            </li>
            <li>
