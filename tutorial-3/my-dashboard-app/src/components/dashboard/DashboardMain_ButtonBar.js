    ...
    return (
        <div className={styles.DashboardMain}>
            <div className={styles.Filters}>
                <div className={styles.ButtonGroup}>
                    <ButtonGroup color="primary" aria-label="outlined primary button group">
                        <Button variant={timePeriod === 0 ? "contained" : "outlined"} onClick={ () => handleTimePeriodChange(0)}>This Year</Button>
                        <Button variant={timePeriod === 1 ? "contained" : "outlined"} onClick={ () => handleTimePeriodChange(1)}>This Quarter</Button>
                        <Button variant={timePeriod === 2 ? "contained" : "outlined"} onClick={ () => handleTimePeriodChange(2)}>This Month</Button>
                    </ButtonGroup>
                </div>
            ...
            <div className={styles.Chart}>
                <AreaChart measures={[Ldm.CountOfTransactions]} stackBy={Ldm.ProductCategory} viewBy={[Ldm.DateMonth.Short]}></AreaChart>
                <InsightView insight={Ldm.Insights.RevenueTrendByProductCategory} filters={[timePeriodFilter]}/>
            </div>
