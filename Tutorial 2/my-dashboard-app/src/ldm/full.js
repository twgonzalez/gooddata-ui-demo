...
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2020-10-22T22:10:46.463Z; */
...
export const Insights = {
  ...
  /**
   * Insight Title: Heatmap returns
   * Insight ID: acjEZlxZb4Re
   */
  ,
  HeatmapReturns: "acjEZlxZb4Re"
  /**
   * Insight Title: Returns per ID
   * Insight ID: abeE4uoKdKXS
   */
  ,
  ReturnsPerID: "abeE4uoKdKXS"
  /**
   * Insight Title: sj_validation
   * Insight ID: abhGfA2maCxm
   */
  ,
  SjValidation: "abhGfA2maCxm"
  /**
  ...
  Test: "abR78adZcxWn"
  /**
   * Insight Title: Leilani's Insight
   * Insight ID: ac076onXfjwK
   */
  ,
  LeilaniSInsight: "ac076onXfjwK"
  /**
   * Insight Title: Heatmap for product returns
   * Insight ID: aeh78cU0bqnN
   */
  ,
  HeatmapForProductReturns: "aeh78cU0bqnN"
  /**
   * Insight Title: Returned IDs
   * Insight ID: aa68fJZCcSbp
   */
  ,
  ReturnedIDs: "aa68fJZCcSbp"
  /**
  ...
  /**
   * Insight Title: domotz insight
   * Insight ID: ad5jk1s2g0HU
   */
  ,
  DomotzInsight: "ad5jk1s2g0HU"
  /**
